...
export class Pokemon {
	...
	*/
	...
	ignoringAbility() {
		...
		if (this.hasItem('Ability Shield') || this.ability === ('neutralizinggas' as ID) || this.ability === ('weezingfusion' as ID)) return false;
		for (const pokemon of this.battle.getAllActive()) {
			// can't use hasAbility because it would lead to infinite recursion
			if ((pokemon.ability === ('neutralizinggas' as ID) || pokemon.ability === ('weezingfusion' as ID)) && !pokemon.volatiles['gastroacid'] &&
...
*/
	...
	isGrounded(negateImmunity = false) {
		...
		if (this.hasAbility(['levitate', 'eelevate', 'surgesurfer', 'weezingfusion', 'levitatemultihead']) &&
