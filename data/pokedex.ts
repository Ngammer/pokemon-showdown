export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	jolteon: {
		...
		abilities: { 0: "Watts", H: "Lightning Rod" },
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: "Eevee",
	...
	articunogalar: {
		...
		abilities: { 0: "Competitive", H: "Cold mind" },
		heightm: 1.7,
		weightkg: 50.9,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	zapdosgalar: {
		...
		abilities: { 0: "Defiant", H: "Watt Feather" },
		heightm: 1.6,
		weightkg: 58.2,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	moltresgalar: {
		...
		abilities: { 0: "Berserk", H: "Sinister Flame" },
		heightm: 2,
		weightkg: 66,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	mew: {
		...
		abilities: { 0: "Synchronize", H: "Ancient Intelligence" },
		heightm: 0.4,
		weightkg: 4,
		color: "Pink",
		tags: ["Mythical"],
