export const Items: import('../sim/dex-items').ItemDataTable = {
	...
	gianttotem: {
		...
		itemUser: ["Raticate-Alola", 'Marowak-Alola', "Electrode-Hisui", "Arcanine-Hisui", "Xatu", "Donphan", "Lilligant-Hisui", "Avalugg-Hisui", "Spyshoos", "Vikavolt", "Ribombee", "Wishiwashi", "Araquanid", "Lurantis", "Salazzle", "Mimikyu", "Kommo-o", "Kleavor", "Sneasler", "Wyrdeer", "Ursaluna", "Basculegion", "Basculegion-F", "Klawf", "Bombirdier", "Orthworm", "Dondozo", "Tatsugiri", "Tatsugiri-Droopy", "Tatsugiri-Stretchy", "Great Tusk", "Iron Treads"],
		num: -103,
		gen: 6,
	...
	toxtricite: {
		name: "Toxtricite",
		spritenum: 607,
		megaStone: { "Toxtricity": "Toxtricity-Amped-Mega",
	...
	urshifite: {
		name: "Urshifite",
		spritenum: 607,
		megaStone: { "Urshifu": "Urshifu-Single-Strike-Mega",
			"Urshifu-Rapid-Strike": "Urshifu-Rapid-Strike-Mega" },
	...
	decidueyite: {
		...
		megaStone: {
			...
			"Decidueye-Hisui": "Decidueye-Hisui-Mega" },
	...
	samurottite: {
		...
		megaStone: {
			...
			"Samurott-Hisui": "Samurott-Hisui-Mega" },
	...
	forretressite: {
		name: "Forretressite",
		spritenum: 607,
		megaStone: {"Forretress": "Forretress-Mega",},
		itemUser: ["Forretress"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	ludicolite: {
		name: "Ludicolite",
		spritenum: 607,
		megaStone: {"Ludicolo": "Ludicolo-Mega",},
		itemUser: ["Ludicolo"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	dusknoirite: {
		name: "Dusknoirite",
		spritenum: 607,
		megaStone: {"Dusknoir": "Dusknoir-Mega",},
		itemUser: ["Dusknoir"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	porigonzite: {
		name: "Porigon-Zite",
		spritenum: 607,
		megaStone: {"Porigon-Z": "Porigon-Z-Mega",},
		itemUser: ["Porigon-Z"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	toxicroakite: {
		name: "Toxicroakite",
		spritenum: 607,
		megaStone: {"Toxicroak": "Toxicroak-Mega",},
		itemUser: ["Toxicroak"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	yanmegite: {
		name: "Yanmegite",
		spritenum: 607,
		megaStone: {"Yanmega": "Yanmega-Mega",},
		itemUser: ["Yanmega"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	cresselite: {
		name: "Cresselite",
		spritenum: 607,
		megaStone: {"Cresselia": "Cresselia-Mega",},
		itemUser: ["Cresselia"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	gourgite: {
		...
		megaStone: {
			...
			"Gourgeist-Small": "Gourgeist-Small-Mega",
			"Gourgeist-Large": "Gourgeist-Large-Mega",
			"Gourgeist-Super": "Gourgeist-Super-Mega"
		},
		itemUser: ["Gourgeist", "Gourgeist-Small", "Gourgeist-Large", "Gourgeist-Super"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
		num: -158,
	...
	yveltite: {
		name: "Yveltite",
		spritenum: 607,
		megaStone: {"Yveltal": "Yveltal-Mega",},
		itemUser: ["Yveltal"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	xernite: {
		name: "Xernite",
		spritenum: 607,
		megaStone: {"Xerneas": "Xerneas-Mega",},
		itemUser: ["Xerneas"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	volcanite: {
		name: "Volcanite",
		spritenum: 607,
		megaStone: {"Volcanion": "Volcanion-Mega",},
		itemUser: ["Volcanion"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	dhelmite: {
		name: "Dhelmite",
		spritenum: 607,
		megaStone: {"Dhelmise": "Dhelmise-Mega",},
		itemUser: ["Dhelmise"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	kommonite: {
		name: "Kommonite",
		spritenum: 607,
		megaStone: {"Kommo-o": "Kommo-o-Mega",},
		itemUser: ["Kommo-o"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	boldtundite: {
		name: "Boldtundite",
		spritenum: 607,
		megaStone: {"Boldtund": "Boldtund-Mega",},
		itemUser: ["Boldtund"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	forsmothite: {
		name: "Forsmothite",
		spritenum: 607,
		megaStone: {"Frosmoth": "Frosmoth-Mega",},
		itemUser: ["Frosmoth"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	obstagoonite: {
		name: "Obstagoonite",
		spritenum: 607,
		megaStone: {"Obstagoon": "Obstagoon-Mega",},
		itemUser: ["Obstagoon"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	perrserkerite: {
		name: "Perrserkerite",
		spritenum: 607,
		megaStone: {"Perrserker": "Perrserker-Mega",},
		itemUser: ["Perrserker"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	dragapultite: {
		name: "Dragapultite",
		spritenum: 607,
		megaStone: {"Dragapult": "Dragapult-Mega",},
		itemUser: ["Dragapult"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	hydrapplite: {
		name: "Hydrapplite",
		spritenum: 607,
		megaStone: {"Hydrapple": "Hydrapple-Mega",},
		itemUser: ["Hydrapple"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	tinkatitex: {
		name: "Tinkatite-X",
		spritenum: 607,
		megaStone: {"Tinkaton": "Tinkaton-Mega-X",},
		itemUser: ["Tinkaton"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	tinkatitey: {
		name: "Tinkatite-Y",
		spritenum: 607,
		megaStone: {"Tinkaton": "Tinkaton-Mega-Y",},
		itemUser: ["Tinkaton"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	cetitanite: {
		name: "Cetitanite",
		spritenum: 607,
		megaStone: {"Cetitan": "Cetitan-Mega",},
		itemUser: ["Cetitan"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
	...
	gholdenite: {
		name: "Gholdenite",
		spritenum: 607,
		megaStone: {"Gholdengo": "Gholdengo-Mega",},
		itemUser: ["Gholdengo"],
		onTakeItem(item, source) {
			return !item.megaStone?.[source.baseSpecies.baseSpecies];
		},
