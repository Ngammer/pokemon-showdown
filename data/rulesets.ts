...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
		...
		onBegin() {
			for (const pokemon of this.getAllPokemon()) {
				if (pokemon.species.isMega || pokemon.species.isPrimal ||
					pokemon.species.isTotem || pokemon.species.forme === "Ultra") {
	...
	/* formesclause: {
		...
		onValidateTeam(team, format) {
			...
			for (const set of team) {
				const species = this.dex.species.get(set.species);
				if (speciesTable.has(species.forme) && (species.forme !== ("Alola") &&
				species.forme !== ("Hisui") && species.forme !== ("Galar") && species.forme !== ("Paldea"))) {
